	...
	<div class="form-group row">
		...
		<div class="col-sm-6">
			<input type="text" class="form-control form-control-user" name="rol"
				id="rol" placeholder="Rol" value="<%=userToEdit.getRol()%>">
		</div>
	...
	<div class="form-group row">
		<div class="col-sm-6 mb-3 mb-sm-0">
			<input type="password" class="form-control form-control-user"
				name="password" id="password" <%if (puedeEditar) {%>
				value="<%=userToEdit.getContrasenia()%>" <%} else {%>
				disabled="disabled" value="******" <%}%> placeholder="Password">
		</div>
		<div class="col-sm-6">
			<input type="password" class="form-control form-control-user"
				name="repeatpassword" id="repeatpassword" <%if (puedeEditar) {%>
				value="<%=userToEdit.getContrasenia()%>" <%} else {%>
